...
public class Memcache {
    ...
    public static <T> T get(Class<T> aClass, String id) {
        return aClass.cast(MemcacheServiceFactory.getMemcacheService(aClass.getName()).get(id));
    }
    ...
    public static <String, T> Map<String, T> getAll(Class<T> aClass, Collection<String> ids) {
        ...
        for (Map.Entry<String, Object> entry : all.entrySet()) {
            map.put(entry.getKey(), aClass.cast(entry.getValue()));
        }
        return map;
    }

    public static <T> void put(String id, T object, Expiration expiration) {
        MemcacheServiceFactory.getMemcacheService(object.getClass().getName()).put(id, object, expiration);
    }

    public static <T> void put(String id, T object) {
        MemcacheServiceFactory.getMemcacheService(object.getClass().getName()).put(id, object);
    }
